...
public class KafkaProducerConfig {
  ...
  @Bean
  public ProducerFactory<String, PaymentCompensationEvent> compensationProducerFactory() {
  ...
  @Bean
  public KafkaTemplate<String, PaymentCompensationEvent> compensationKafkaTemplate() {
